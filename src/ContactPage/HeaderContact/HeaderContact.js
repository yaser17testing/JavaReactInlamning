...
import Navig from "../../components/Header/RouterButton";


import logo from '../../assets/image/Logo.svg'
import ButtonArrow from "../../components/Funktioner/ButtonArrow";
      ...
      <FontAwesomeIcon icon={faLinkedin} style={{ color: '#131415;' }} />
        ...
        <div className="undermenu">
          ...
          <a className="btn-yellow" href="#">
            Login <i className="fa-solid fa-arrow-up-right-from-square"><ButtonArrow/></i>
          </a>
        </div>
      </div>
    </div>
